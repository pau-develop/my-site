const projects = [
  {
    ...
    features: [
      ...
      {
        title: "Gallery",
        text: "In the gallery section, all the drawings from the database are displayed in pages of four drawings each. Clicking on a drawing will bring up the Drawing page.",
        img: "/junk03.png",
        alt: "Gallery page",
      },
      {
